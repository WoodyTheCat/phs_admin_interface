...
export default function FontSize({
  ...
  const handleInputBlur = () => {
    if (inputValue !== "" && inputChangeFlag) {
      updateFontSizeByInputValue(Number(inputValue));
    }
  };
  ...
  return (
    <>
      ...
      <input
        className="bg-background [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none text-center"
        type="number"
        value={inputValue}
        disabled={disabled}
