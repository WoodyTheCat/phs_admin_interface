...
import { ComponentData, PuckConfig, Permissions, UserGenerics } from "../types";
...
export type GetPermissions<UserConfig extends PuckConfig = PuckConfig> = (
  params?: PermissionsArgs<UserConfig>,
) => Partial<Permissions>;

type ResolvePermissions<UserConfig extends PuckConfig = PuckConfig> = (
  params?: PermissionsArgs<UserConfig>,
  force?: boolean,
) => void;

export type RefreshPermissions<UserConfig extends PuckConfig = PuckConfig> = (
  params?: PermissionsArgs<UserConfig>,
  force?: boolean,
) => void;
